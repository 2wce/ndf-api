    ...
    Query: {
        events(parent, args, { prisma }, info) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    return yield prisma.events().$fragment(info);
                }
                catch (error) {
        ...
        event(_, { id }, { prisma }, info) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const event = yield prisma.event({ id }).$fragment(info);
        ...
        addEvent(parent, { input }, { prisma }, info) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const event = yield prisma.createEvent(Object.assign({}, rest, { agenda: { connect: { id: agendaId } }, region: { connect: { id: regionId } }, memberLevel: { connect: { id: memberLevelId } } }));
